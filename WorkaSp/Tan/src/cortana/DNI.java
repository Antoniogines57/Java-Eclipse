...
public class DNI {
	...
	public void setApellidos(String app) {
		if(app!=null&&app.equals(" ")==false) {
			...
			System.out.println("Los apellidos introducidos no son validos.");
		}
	}
	public void setFechaDeVencimiento(Fecha inn) {
		if(inn!=null&&inn.fechaAnteriorA(deVencimiento)==false) {
			deVencimiento=inn.newFecha();
		}
		else {
			System.out.println("La fecha indicada es anterior a la establecida.");
		}
	}
}
